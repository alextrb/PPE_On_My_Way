...
public class Checkpoint_Activity extends AppCompatActivity implements LocationListener, OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {

    private TextView textViewNameCheckpoint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkpoint_);

        latLngList = new ArrayList<>();
        checkPointList = new ArrayList<>();

        textViewNameCheckpoint = (TextView) findViewById(R.id.textViewNameCheckpoint);
